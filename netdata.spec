...
Source0  : https://github.com/netdata/netdata/releases/download/v1.44.3/netdata-v1.44.3.tar.gz
...
%prep
%setup -q -n netdata-v1.44.3
cd %{_builddir}/netdata-v1.44.3
pushd ..
cp -a netdata-v1.44.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712608156
unset LD_AS_NEEDED
