...
Source0  : https://github.com/netdata/netdata/releases/download/v1.37.0/netdata-v1.37.0.tar.gz
...
%prep
%setup -q -n netdata-v1.37.0
cd %{_builddir}/netdata-v1.37.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669933057
unset LD_AS_NEEDED
