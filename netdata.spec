...
Source0  : https://github.com/netdata/netdata/releases/download/v1.29.1/netdata-v1.29.1.tar.gz
...
%prep
%setup -q -n netdata-v1.29.1
cd %{_builddir}/netdata-v1.29.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612884628
unset LD_AS_NEEDED
...
cp %{_builddir}/netdata-v1.29.1/LICENSE %{buildroot}/usr/share/package-licenses/netdata/16f29acc74321cf07b75fbb3a318a263b71e218a
%make_install
