...
Source0  : https://github.com/netdata/netdata/releases/download/v1.30.1/netdata-v1.30.1.tar.gz
...
%prep
%setup -q -n netdata-v1.30.1
cd %{_builddir}/netdata-v1.30.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618244260
unset LD_AS_NEEDED
...
cp %{_builddir}/netdata-v1.30.1/LICENSE %{buildroot}/usr/share/package-licenses/netdata/16f29acc74321cf07b75fbb3a318a263b71e218a
cp %{_builddir}/netdata-v1.30.1/mqtt_websockets/LICENSE %{buildroot}/usr/share/package-licenses/netdata/31a3d460bb3c7d98845187c716a30db81c44b615
cp %{_builddir}/netdata-v1.30.1/mqtt_websockets/MQTT-C/LICENSE %{buildroot}/usr/share/package-licenses/netdata/c0f448701fe7c85d713f3d6fe08832a2c17e9287
cp %{_builddir}/netdata-v1.30.1/mqtt_websockets/c-rbuf/LICENSE %{buildroot}/usr/share/package-licenses/netdata/a8a12e6867d7ee39c21d9b11a984066099b6fb6b
%make_install
