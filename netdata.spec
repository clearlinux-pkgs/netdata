...
Source0  : https://github.com/netdata/netdata/releases/download/v1.43.0/netdata-v1.43.0.tar.gz
...
%prep
%setup -q -n netdata-v1.43.0
cd %{_builddir}/netdata-v1.43.0
pushd ..
cp -a netdata-v1.43.0 buildavx2
popd
