...
Source0  : https://github.com/netdata/netdata/releases/download/v1.38.0/netdata-v1.38.0.tar.gz
...
%prep
%setup -q -n netdata-v1.38.0
cd %{_builddir}/netdata-v1.38.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675732698
unset LD_AS_NEEDED
