...
Source0  : https://github.com/netdata/netdata/releases/download/v1.20.0/netdata-v1.20.0.tar.gz
...
%prep
%setup -q -n netdata-v1.20.0
cd %{_builddir}/netdata-v1.20.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582301967
unset LD_AS_NEEDED
...
cp %{_builddir}/netdata-v1.20.0/LICENSE %{buildroot}/usr/share/package-licenses/netdata/16f29acc74321cf07b75fbb3a318a263b71e218a
%make_install
...
/usr/lib64/netdata/conf.d/mongodb.conf
