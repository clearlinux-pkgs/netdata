...
Source0  : https://github.com/netdata/netdata/releases/download/v1.21.1/netdata-v1.21.1.tar.gz
...
%prep
%setup -q -n netdata-v1.21.1
cd %{_builddir}/netdata-v1.21.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587057906
unset LD_AS_NEEDED
...
cp %{_builddir}/netdata-v1.21.1/LICENSE %{buildroot}/usr/share/package-licenses/netdata/16f29acc74321cf07b75fbb3a318a263b71e218a
%make_install
...
/usr/lib64/netdata/conf.d/ebpf_process.conf
...
/usr/libexec/netdata/netdata-switch-dashboard.sh
