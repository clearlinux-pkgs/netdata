...
Source0  : https://github.com/netdata/netdata/releases/download/v1.43.1/netdata-v1.43.1.tar.gz
...
%prep
%setup -q -n netdata-v1.43.1
cd %{_builddir}/netdata-v1.43.1
pushd ..
cp -a netdata-v1.43.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698418407
unset LD_AS_NEEDED
