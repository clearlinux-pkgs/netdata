...
Source0  : https://github.com/netdata/netdata/releases/download/v1.38.1/netdata-v1.38.1.tar.gz
Summary  : The Common Unix Printing System plugin for netdata
Group    : Development/Tools
License  : Apache-2.0 BSD-3-Clause BSL-1.0 GPL-2.0 GPL-3.0 GPL-3.0+ LGPL-3.0 Libpng
...
%prep
%setup -q -n netdata-v1.38.1
cd %{_builddir}/netdata-v1.38.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676390144
unset LD_AS_NEEDED
